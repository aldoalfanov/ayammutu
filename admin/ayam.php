	    	...
	    	<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="index.php?halaman=hapusayam&id=<?php echo $pecah['id_ayam']; ?>" class="btn btn-danger btn-xs" onlick="return confirm('yakin hapus?')"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
							<a href="index.php?halaman=ubahayam&id=<?php echo $pecah['id_ayam'];?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i>Ubah</a>
